...
class FarmartController extends PublicController
{
    ...
    public function __construct(BaseHttpResponse $response)
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            'ajaxGetProducts',
            'ajaxGetProductRazenStudio',
            'ajaxGetProductRazenTeknologi',
            'ajaxGetProductRazenProject',
            'ajaxGetProductRazenInstitute',
            'ajaxGetProductRazenFarm',
            'ajaxGetProductRazenCloth',
            'ajaxGetProductKolhype',
            'ajaxGetProductMamiClean',
            'ajaxGetProductRazenHoliday',
            'ajaxGetProductRazenSkin',
    ...
    public function ajaxGetProductRazenStudio(Request $request)
    {
        $products = get_products_by_razen_studio([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenTeknologi(Request $request)
    {
        $products = get_products_by_razen_teknologi([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenProject(Request $request)
    {
        $products = get_products_by_razen_project([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenInstitute(Request $request)
    {
        $products = get_products_by_razen_institute([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenFarm(Request $request)
    {
        $products = get_products_by_razen_farm([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenCloth(Request $request)
    {
        $products = get_products_by_razen_cloth([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductKolhype(Request $request)
    {
        $products = get_products_by_kolhype([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductMamiClean(Request $request)
    {
        $products = get_products_by_mami_clean([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenHoliday(Request $request)
    {
        $products = get_products_by_razen_holiday([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
    ...
    public function ajaxGetProductRazenSkin(Request $request)
    {
        $products = get_products_by_razen_skin([
            'collections' => [
                'by' => 'id',
                'value_in' => [(int)$request->input('collection_id')],
            ],
