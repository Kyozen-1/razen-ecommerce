...
use Botble\Base\Supports\JsonableHtmlString;
use Carbon\Carbon;
use Exception;
...
class BaseHelper
{
    ...
    public function html(array|string|null $dirty, array|string $config = null): JsonableHtmlString
    {
        return new JsonableHtmlString($this->clean($dirty, $config));
    }
